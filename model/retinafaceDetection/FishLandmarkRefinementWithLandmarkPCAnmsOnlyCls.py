...
class FishLandmarkRefinementWithLandmarkPCAnmsOnlyCls:
    ...
    def forward(self, loc_data, conf_data, landm_data, prior_data):
        ...
        #                                                                                           prior_landmarks,
        #                                                                                        self.variance)
        # decoded_landmarks_p = utils_fish_landmark_detection.decode_landmarks_with_pca_param(landm_data.data,
        #                                                                                     prior_landmarks,
        #                                                                                     self.img_size_normalized_pca_features)
        decoded_landmarks_p = prior_landmarks
